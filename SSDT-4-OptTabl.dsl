 ...
 *
 * Disassembly of SSDT-4-OptTabl.aml, Fri Mar 22 20:13:42 2019
 *
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        Method (GC6I, 0, Serialized)
        {
            ...
            While (LNotEqual (\_SB.GGIV (0x01060015), One))
            {
                Sleep (One)
            }
        }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            While (LNotEqual (\_SB.GGIV (0x01060015), Zero))
            {
                Sleep (One)
            }
        ...
        {
            If (LEqual (\_SB.GGIV (0x01060015), Zero))
            {
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x22)
                {
                    ...
                    If (And (GPSC, One))
                    {
                        Store (One, \_SB.AC.GPSF)
                        \_SB.AC.ADJP (Or (PCAP, 0x40000000))
                        Store (Zero, \_SB.AC.GPSF)
                    }
                }
                Case (0x23)
                {
