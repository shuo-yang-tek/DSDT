 ...
 *
 * Disassembly of DSDT.aml, Fri Mar 22 20:13:42 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00019C92 (105618)
 *     Revision         0x02
 *     Checksum         0xAE
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x7AEA6000, 0x0650)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0x7A6A1F18, 0x10)
        ...
        Device (HDAS)
        {
            ...
            Method (GHDA, 1, NotSerialized)
            {
                ...
                If (LAnd (And (CMD, 0x02), And (BARL, 0xFFFFC000)))
                {
                    ...
                    Or (ICSR, One, ICSR)
                    Store (0x03E8, Local7)
                    While (LAnd (LNotEqual (And (ICSR, 0x03), 0x02), LNotEqual (Local7, Zero)))
                    {
                        Stall (One)
                        Decrement (Local7)
                    }
        ...
        Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
        {
            If (LEqual (Arg0, ToUUID ("3dddfaa6-361b-4eb4-a424-8d10089d1653") /* Physical Presence Interface */))
            {
                Switch (ToInteger (Arg2))
                {
                    ...
                    Case (0x02)
                    {
                        ToInteger (DerefOf (Index (Arg3, Zero)), RQST)
                        Store (Zero, SRSP)
                        Store (0x02, FLAG)
                        Store (OFST, TMF1)
                        Store (Zero, SRSP)
            ...
            Method (GCMD, 3, Serialized)
            {
                ...
                If (LEqual (ToInteger (Arg1), 0x63))
                {
                    If (^^PCI0.LPCB.EC.ECOK)
                    {
                        ...
                        If (One)
                        {
                            Store (^^PCI0.LPCB.EC.FBF2, Local1)
                            Store (Zero, ^^PCI0.LPCB.EC.FCMD)
                        }
                ...
                If (LEqual (ToInteger (Arg1), 0x76))
                {
                    ...
                    {
                        Store (ARGS, Local4)
                        Store (And (ShiftRight (Local4, 0x18), 0xFF), Local4)
                        Switch (Local4)
                        {
                            Case (One)
                            {
                                Store (0x10, P80H)
                                Store (ARGS, V118)
                                ToBCD (And (V118, 0x3F), C602)
                                Store (C602, ^^PCI0.LPCB.EC.FBUF)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x06), 0x3F), C603)
                                Store (C603, ^^PCI0.LPCB.EC.FBF1)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x0C), 0x1F), C604)
                                Store (C604, ^^PCI0.LPCB.EC.FBF2)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x11), 0x07), C601)
                                Store (C601, ^^PCI0.LPCB.EC.FDAT)
                            ...
                            Case (0x02)
                            {
                                Store (0x20, P80H)
                                Store (ARGS, V118)
                                Store (And (V118, 0xFF), C701)
                                Store (ARGS, V118)
                                Store (And (ShiftRight (V118, 0x08), 0xFF), C801)
                            }
                            Case (0x03)
                            {
                                Store (0x30, P80H)
                                Store (ARGS, V118)
                                ToBCD (And (V118, 0x3F), C702)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x06), 0x1F), C703)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x0B), 0x3F), C704)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x11), 0x1F), C705)
                                Store (C701, ^^PCI0.LPCB.EC.FDAT)
                                Store (C702, ^^PCI0.LPCB.EC.FBUF)
                                Store (C703, ^^PCI0.LPCB.EC.FBF1)
                                Store (C704, ^^PCI0.LPCB.EC.FBF2)
                                Store (C705, ^^PCI0.LPCB.EC.FBF3)
                            ...
                            Case (0x04)
                            {
                                Store (0x40, P80H)
                                Store (ARGS, V118)
                                ToBCD (And (V118, 0x3F), C802)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x06), 0x1F), C803)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x0B), 0x3F), C804)
                                Store (ARGS, V118)
                                ToBCD (And (ShiftRight (V118, 0x11), 0x1F), C805)
                                Store (C801, ^^PCI0.LPCB.EC.FDAT)
                                Store (C802, ^^PCI0.LPCB.EC.FBUF)
                                Store (C803, ^^PCI0.LPCB.EC.FBF1)
                                Store (C804, ^^PCI0.LPCB.EC.FBF2)
                                Store (C805, ^^PCI0.LPCB.EC.FBF3)
                                Store (0xC8, ^^PCI0.LPCB.EC.FCMD)
                            }
                            Case (0x05)
                            {
                                Store (0x50, P80H)
                                Store (ARGS, V118)
                                Store (And (V118, 0xFF), Local4)
                            ...
                            Case (0x06)
                            {
                                Store (0x60, P80H)
                                Store (ARGS, V118)
                                Store (And (ARGS, 0xFF), Local0)
                                Store (Local0, ^^PCI0.LPCB.EC.FBUF)
                                Store (ARGS, V118)
                                Store (And (ShiftRight (ARGS, 0x08), 0xFF), Local0)
                                Store (Local0, ^^PCI0.LPCB.EC.FDAT)
                                Store (0xFF, ^^PCI0.LPCB.EC.FBF1)
                                Store (0xCB, ^^PCI0.LPCB.EC.FCMD)
                            }
                ...
                If (LEqual (ToInteger (Arg1), 0x50))
                {
                    ...
                    If (^^PCI0.LPCB.EC.ECOK)
                    {
                        ...
                        Store (Zero, ^^PCI0.LPCB.EC.FBF1)
                        Store (Zero, ^^PCI0.LPCB.EC.FBF2)
                        Store (Zero, ^^PCI0.LPCB.EC.FBF3)
                ...
                If (LEqual (ToInteger (Arg1), 0x51))
                {
                    ...
                    If (^^PCI0.LPCB.EC.ECOK)
                    {
                        ...
                        Store (Zero, C007)
                        Or (C007, Local0, C007)
                        Or (C007, ShiftLeft (Local1, 0x08), C007)
                        Sleep (0x03E8)
                        Store (Zero, ^^PCI0.LPCB.EC.FDAT)
                        Store (Zero, ^^PCI0.LPCB.EC.FBUF)
                        Store (Zero, ^^PCI0.LPCB.EC.FBF1)
                        ...
                        Store (Zero, C008)
                        Or (C008, Local0, C008)
                        Or (C008, ShiftLeft (Local1, 0x08), C008)
                        Store (Zero, Local0)
                        Or (Local0, C008, Local0)
                        Or (Local0, ShiftLeft (C007, 0x10), Local0)
                    }
            ...
            Method (SCMD, 3, Serialized)
            {
                ...
                If (LEqual (ToInteger (Arg1), 0x75))
                {
                    ...
                    If (^^PCI0.LPCB.EC.ECOK)
                    {
                        ...
                        Store (ARGS, WBUF)
                        If (LAnd (LLessEqual (Local1, 0xD9), LGreaterEqual (Add (Local1, Local3), 0xD9)))
                        {
                            Subtract (0xD9, Local1, Local4)
                            And (DerefOf (Index (WBUF, Local4)), 0x40, Local6)
                            And (^^PCI0.LPCB.EC.AIRP, 0xBF, Local7)
                            Store (Or (Local6, Local7), Index (WBUF, Local4))
                        }
                ...
                If (LEqual (ToInteger (Arg1), 0x79))
                {
                    ...
                    Switch (ToInteger (Local1))
                    {
                        ...
                        Case (0x0E)
                        {
                            If (^^PCI0.LPCB.EC.ECOK)
                            {
                                Store (And (Local2, 0xFF), ^^PCI0.LPCB.EC.GFOF)
                            }
                            Else
                            {
                                Store (Ones, Local0)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC)
        {
            ...
            Method (_Q16, 0, NotSerialized)  // _Qxx: EC Query
            {
                ...
                If (And (NVBB, 0xFFFF))
                {
                    If (LOr (ADP, LNotEqual (And (PSF1, 0x30), 0x20)))
                    {
                        Store (Zero, BBST)
                        ...
                        If (^^^^WMI.HKDR)
                        {
                            If (And (PSF2, 0x00400000))
                            {
                                If (ECOK)
                                {
                                    ...
                                    Or (ShiftLeft (Local1, 0x08), 0x62, Local0)
                                }
                                Else
                                {
                                    Store (0xFF62, Local0)
        ...
        Device (SYNM)
        {
            Name (_HID, EisaId ("SYN1218"))  // _HID: Hardware ID
            Name (_CID, EisaId ("PNP0F13"))  // _CID: Compatible ID
            Name (_UID, 0x03)  // _UID: Unique ID
            Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PCI0.LPCB.EC.ECOK)
                {
                    ...
                    If (And (PSF0, 0x02))
                    {
                        If (PPFG)
                        {
                            If (LLessEqual (Local0, Subtract (\_SB.PCI0.LPCB.EC.PSV, \_SB.PCI0.LPCB.EC.DTHL)))
                            {
                                \_SB.AC.ADJP (0x80000000)
                                Store (Zero, PPFG)
                            }
                        }
                        ElseIf (LGreaterEqual (Local0, \_SB.PCI0.LPCB.EC.PSV))
                        {
                            Store (One, PPFG)
                            \_SB.AC.ADJP (Zero)
                        }
    ...
    Scope (_SB.PCI0.XHC.RHUB.HS01)
    {
        ...
        {
            If (LEqual (^^^^RP07.PXSX.VID, 0x12421B21))
            {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            ...
            Name (PLDP, Package (0x01)
            {
                Buffer (0x10)
                {
                    ...
                    /* 0008 */  0x69, 0x8C, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
        }
    ...
    Scope (_SB.PCI0.XHC.RHUB.HS06)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            ...
            Name (PLDP, Package (0x01)
            {
                ...
                {
                    /* 0000 */  0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,
                    /* 0008 */  0x69, 0x0C, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
        }
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Name (PLDP, Package (0x01)
            {
                Buffer (0x10)
                {
                    ...
                    /* 0008 */  0x69, 0x0C, 0x03, 0x03, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
        }
    ...
    Scope (_SB.WMI)
    {
        Method (PSTG, 0, Serialized)
        {
            ...
            If (LNotEqual (^^PCI0.RP09.PXSX.VID, 0xFFFF))
            {
                If (LEqual (^^PCI0.RP09.PXSX.BCC, One))
                {
                    Switch (ToInteger (^^PCI0.RP09.PXSX.SCC))
                    {
                        Case (0x04)
                        {
                            If (LEqual (^^PCI0.RP09.PXSX.VID, 0x8086))
                            {
                                Return (One)
                            }
                        }
                        Case (0x06)
                        {
                            If (LEqual (^^PCI0.RP09.PXSX.PI, One))
                            {
                                Return (One)
                            }
                        }
                        Case (0x08)
                        {
                            If (LEqual (^^PCI0.RP09.PXSX.PI, 0x02))
                            {
                                Return (One)
                            }
                        }
            ...
            If (LNotEqual (^^PCI0.RP13.PXSX.VID, 0xFFFF))
            {
                If (LEqual (^^PCI0.RP13.PXSX.BCC, One))
                {
                    Switch (ToInteger (^^PCI0.RP13.PXSX.SCC))
                    {
                        Case (0x04)
                        {
                            If (LEqual (^^PCI0.RP13.PXSX.VID, 0x8086))
                            {
                                Return (One)
                            }
                        }
                        Case (0x06)
                        {
                            If (LEqual (^^PCI0.RP13.PXSX.PI, One))
                            {
                                Return (One)
                            }
                        }
                        Case (0x08)
                        {
                            If (LEqual (^^PCI0.RP13.PXSX.PI, 0x02))
                            {
                                Return (One)
                            }
                        }
        ...
        {
            Store (0x07, ^^PCI0.LPCB.EC.FDAT)
            Store (And (Arg0, 0xFF), ^^PCI0.LPCB.EC.FBUF)
